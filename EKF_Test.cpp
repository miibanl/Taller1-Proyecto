...
int MeasUpdate() {
    ...
    G(2,1)=2.16050345227544e-07;
    G(3,1)=-3.27382770920699e-07;
    G(4,1)=0.0;
    G(5,1)=0.0;
    G(6,1)=0.0;
    ...
    P(1,3)=25850.3882249601;
    P(1,4)=-941.143711797184 ;
    P(1,5)=10455.2839772174;
    P(1,6)=25850.3882249601;
    P(2,1)=16767.2171636716;
    P(2,2)=16682.1727780171;
    P(2,3)=14283.1545059351;
    P(2,4)=-941.143711797184 ;
    P(2,5)=10455.2839772174;
    P(2,6)=25850.3882249601;
    P(3,1)=-0.0594779293881896;
    P(3,2)=3.70889400821746;
    P(3,3)=996.435188908888;
    P(3,4)=-941.143711797184;
    P(3,5)=10455.2839772174;
    P(3,6)=25850.3882249601;
    P(4,1)=5.68203493498356;
    P(4,2)=5.68203493498356;
    P(4,3)=992.623676969809;
    P(4,4)=-941.143711797184;
    P(4,5)=10455.2839772174;
    P(4,6)=25850.3882249601;
    P(5,1)=-941.143711797184;
    P(5,2)=10455.2839772174;
    P(5,3)=25850.3882249601;
    P(5,4)=-941.143711797184;
    P(5,5)=10455.2839772174;
    P(5,6)=25850.3882249601;
    P(6,1)=16767.2171636716;
    P(6,2)=16682.1727780171;
    P(6,3)=14283.1545059351;
    P(6,4)=-941.143711797184 ;
    P(6,5)=10455.2839772174;
    P(6,6)=25850.3882249601;
